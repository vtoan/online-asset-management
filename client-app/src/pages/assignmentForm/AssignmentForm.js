...
export default function UserForm() {
    ...
    const handleSubmit = event => {
        ...
        const validate = (assignment) => {
            if (assignment.userId == "") alert("User' s name can't not be empty, please!")
            else if (assignment.assetId == "") alert("Asset's name can't be empty, please!")
        ...
        if (id) {
            ...
            validate(assignment);
            http.put("/api/assignments/" + id, assignment).then(resp => {
