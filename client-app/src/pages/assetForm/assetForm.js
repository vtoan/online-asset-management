            ...
            <form className="form-asset" onSubmit={handleSubmit}>
                <Row className="row-create-new">
                    ...
                    <Col className="col-create-new">
                        <input type="text" defaultValue={dataEdit?.nameAsset ?? ""} className="name-new-asset" Name="nameAsset" />
                    </Col>
                </Row>
                <Row className="row-create-new">
                    <Col className="col-asset" xs="2">
                    ...
                    <Col className="col-create-new">
                        <select Name="nameCategoryAsset" defaultValue={dataEdit?.category ?? ""} className="category-asset">
                ...
                <Row className="row-create-new">
                    ...
                    <Col className="col-create-new">
                        <input type="date" className="date-asset" Name="dateAddAsset" defaultValue={dataEdit?.date ?? ""} />
                    </Col>
                </Row>
                <Row className="row-create-new">
                    <Col className="col-asset" xs="2">
